from . import *
from .connection import SnowflakeConnectionHandler
import uuid
...
class Snowflake:
    ...
    def __init__(self):
        ...
        """
        self.connection = SnowflakeConnectionHandler()
    ...
    def _overwrite_table(self, first_row, columns=[]):
        ...
        self.connection._open_cursor()
        self.cursor = self.connection._cursor
        try:
            self.cursor.execute(query, first_row)
            self.commit()
        finally:
            self.connection._close_cursor()
    ...
    def _do_insert(self):
        ...
        self.cursor = self.connection._cursor
        try:
            self.cursor.executemany(self.query, self.insert_data)
            self.commit()
        finally:
            self.connection._close_cursor()
    ...
    def execute_sql_command(self, command, bindvars=list(), commit=False):
        """
    ...
    def execute_query(self, sql, bindvars=None):
        ...
        try:
            ...
            if self.cursor.description:
                ...
                self.column_data = self.cursor.description
    ...
    def get_columns(self, table_name=None):
        ...
        try:
            ...
            for column in self.cursor.description:
                self.column_data.append(self.ColumnData._make(column))
